...
object JokeManager{
    ...
    val listJokesRaw:List<String> = listOf<String>("Chuck Norris doesn't buy wine. He just stares at a bottle of Welches Grape Juice and it turns into 1945 Chateau Mouton Rothschild out of fear.",
    ...
    fun printAllJokes(){
        listJokesRaw.forEach { Log.i("JOKEMANAGER", "joke n°${listJokesRaw.indexOf(it)+1}: ${it}") }
    }
